...
const get_db_connect_adapter = (data_config) => {
    return new Promise((callback) => {
        get_db_connect_main(data_config).then(([error,data]) => {
            ...
            console.log("Data-Adapter-Get-DB-Adapter");
            console.log(error);
            callback([error,null]);
        });
    });
...
const close_db_connect_adapter = (db_connect) => {
    return new Promise((callback) => {
        close_db_connect_main(db_connect).then(([error,data])=> {
            ...
            console.log("Data-Adapter-Close-DB-Connect-Adapter");
            console.log(error);
            callback([error,null]);
        });
    });
        ...
        async.series([
            function(call) {
                get_cache_connect_main(db_connect.data_config).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Update-Item-List-Adapter");
                    console.log(error);
                    callback([error,null]);
                });
            },
                        ...
                        update_item_main(db_connect,item.data_type,item).then(([error,data]) => {
                            ...
                            if(data){
                                delete_cache_string_main(cache_connect,get_cache_item_attr_list_key(item.data_type,data.id)).then(([error,data]) => {
                                    ...
                                    console.log("Data-Adapter-Update-Item-List-2");
                                    console.log(error);
                                    callback([error,null]);
                                });
                            }else{
                            ...
                            console.log("Data-Adapter-Update-Item-List-3");
                            console.log(error);
                            callback([error,null]);
                        });
                    }else{
            ...
            function(call) {
                close_cache_connect_main(cache_connect).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Update-Item-List-4-Error");
                    console.log(error);
                    callback([error,null]);
                });
            },
            ...
            console.log("Data-Adapter-Update-Item-List-5");
            console.log(error);
            callback([error,null]);
        });
    });
        ...
        async.series([
            function(call) {
                get_cache_connect_main(db_connect.data_config).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Update-Item-Adapter");
                    console.log(error);
                    callback([error,null]);
                });
            },
            function(call){
                update_item_main(db_connect,data_type,item_data).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Update-Item-Adapter-2");
                    console.log(error);
                    callback([error,null]);
                });
            },
            ...
            function(call){
                delete_cache_string_main(cache_connect,get_cache_item_attr_list_key(item_data.data_type,item_data.id)).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Update-Item-Adapter-3");
                    console.log(error);
                    callback([error,null]);
                });
            },
            function(call) {
                close_cache_connect_main(cache_connect).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Update-Item-Adapter-4");
                    console.log(error);
                    callback([error,null]);
                });
            },
            ...
            console.log("Data-Adapter-Update-Item-Adapter-END");
            console.log(error);
            callback([error,null]);
        });
    });
        ...
        async.series([
            function(call) {
                get_cache_connect_main(db_connect.data_config).then(([error,data]) => {
                    ...
                    console.log("Get-Item-List-Adapter");
                    console.log(error);
                    callback([error,null]);
                });
            },
            function(call) {
                get_id_list_main(db_connect,data_type,sql,sort_by,page_current,page_size).then(([error,total_count,data_list]) => {
                    ...
                    console.log("Get-Item-List-Adapter-2");
                    console.log(error);
                    callback([error,null]);
                });
            },
            ...
            console.log("Get-Item-List-Adapter-3");
            console.log(error);
            callback([error,null]);
        });
    });
        ...
        async.series([
            function(call) {
                get_cache_connect_main(db_connect.data_config).then(([error,data]) => {
                    ...
                    console.log("Adapter-Get-Item-Adapter");
                    console.log(error);
                    callback([error,null]);
                });
            },
            function(call) {
                get_item_cache_db(cache_connect,db_connect,data_type,id).then(([error,data]) => {
                    ...
                    console.log("Adapter-Get-Item-Adapter-2");
                    console.log(error);
                    callback([error,null]);
                });
            },
            function(call) {
                close_cache_connect_main(cache_connect).then(([error,data]) => {
                    ...
                    console.log("Adapter-Get-Item-Adapter-3");
                    console.log(error);
                    callback([error,null]);
                });
            }
            ...
            console.log("Adapter-Get-Item-Adapter-4");
            console.log(error);
            callback([error,null]);
        });
    });
        ...
        async.series([
            ...
            function(call) {
                    set_cache_string_main(cache_connect,get_cache_item_attr_list_key(data_type,id),cache_string_str).then(([error,data]) => {
                        ...
                        console.log("Data-Adapter-Set-Cache-Item");
                        console.log(error);
                        callback([error,null]);
                    });
            },
            ...
            console.log("Data-Adapter-Set-Cache-Item-2");
            console.log(error);
            callback([error,null]);
        });
    });
        ...
        async.series([
            function(call) {
                get_cache_string_main(cache_connect,get_cache_item_attr_list_key(data_type,id)).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Get-Item-Cache-DB");
                    console.log(error);
                    callback([error,null]);
                });
            },
                    ...
                    get_item_main(db_connect,data_type,id).then(([error,data]) => {
                        if(data){
                            ...
                            set_cache_item(cache_connect,data_type,id,data).then(([error,data2]) => {
                                ...
                                console.log("Data-Adapter-Get-Item-Cache-DB-2");
                                console.log(error);
                                callback([error,null]);
                            });
                        }else{
                        ...
                        console.log("Data-Adapter-Get-Item-Cache-DB-3");
                        console.log(error);
                        callback([error,null]);
                    });
                }
        ...
        async.series([
            function(call) {
                get_cache_connect_main(db_connect.data_config).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Delete-Item-List-Adapter");
                    console.log(error);
                    callback([error,null]);
                });
            },
            function(call) {
                get_id_list_main(db_connect,data_type,sql,{},0,9999).then(([error,total_count,data_list]) => {
                    ...
                    console.log("Data-Adapter-Delete-Item-List-Adapter-2");
                    console.log(error);
                    callback([error,null]);
                });
            },
            ...
            console.log("Data-Adapter-Delete-Item-List-Adapter-3");
            console.log(error);
            callback([error,null]);
        });
    });
        ...
        async.series([
            function(call) {
                get_cache_connect_main(db_connect.data_config).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Delete-Item-Cache-DB");
                    console.log(error);
                    callback([error,null]);
                });
            },
            ...
            function(call){
                delete_cache_string_main(cache_connect,get_cache_item_attr_list_key(data_type,id)).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Delete-Item-Cache-DB-2");
                    console.log(error);
                    callback([error,null]);
                });
            },
            function(call){
                delete_item_main(db_connect,data_type,id).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Delete-Item-Cache-DB-3");
                    console.log(error);
                    callback([error,null]);
                });
            },
            function(call) {
                close_cache_connect_main(cache_connect).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Delete-Item-Cache-DB-4");
                    console.log(error);
                    callback([error,null]);
                });
            },
        ...
        async.series([
            function(call) {
                count_item_list_main(db_connect,data_type,sql).then(([error,data]) => {
                    ...
                    console.log("Data-Adapter-Count-Item-List");
                    console.log(error);
                    callback([error,null]);
                });
            },
